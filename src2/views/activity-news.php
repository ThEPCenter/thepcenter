        ...
        if ($_GET['news_id']) {
            ...
            <div style="margin-left: 15px;">
                <div class="image-set">
                    ...
                    <a class="pic-link" href="../../../Thep_Admin_Panel/ap/views/img/picture/' . $p['name'] . '" data-lightbox="gal-' . $n['gallery_id'] . '" title="' . $p['caption'] . '">                            
                        <img class="example-image" src="../images/pixel-vfl3z5WfW.gif" alt="image ' . $i . ' 0f ' . $no_p . ' thumb" 
                            style="vertical-align: middle; 
                            background: no-repeat white url(../../../Thep_Admin_Panel/ap/views/img/picture/' . $p['name'] . ') -50px 0; 
