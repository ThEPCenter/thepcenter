...
define("DOMAIN", "http://www.thep-center.org");
define("DOMAIN_NAME", "thep-center.org");

define("MAIN", "index.php");
define("BASEPATH", "http://localhost/phpThEP/src/ui_re_db/");
...
// END function path_file
    ...
    function inc_dir($dir) {
        switch ($dir) {
            case "controllers" :
                return 'ui_re_db/controllers';
                break;
            case "image" :
                return 'ui_re_db/image';
                break;
            case "includes" :
                return 'ui_re_db/includes';
                break;
            case "Re_db" :
                return '../Re_db_' . VERSION;
            case "paper_upload" :
                return '../paper_upload';
                break;
            case "script" :
                return 'ui_re_db/script';
                break;
            case "style" :
                return 'ui_re_db/style';
                break;
            case "system" :
                return 'ui_re_db/system';
                break;
            case "views" :
                return 'ui_re_db/views';
                break;
        }
    }
