        ...
        <div id="show-news" class="row">
            ...
            if (isset($_GET['news_id'])) {
                ...
                <div class="col-sm-3 col-md-3">
                    <h3 class="text-center header-type">ประกาศย้อนหลัง</h3>
                    <?php
                    ...
                    while ($etc = mysql_fetch_array($re_etc)) {
                        echo '
                    <p><a href="' . $etc['type'] . '.php?news_id=' . $etc['id'] . '">' . htmlspecialchars_decode($etc['title']) . '</a></p>
                    <div></div>
                    <hr>
                    ';
                    } // END while
                    ?>
                    <a class="all-title" href="notice.php"><em>ประกาศทั้งหมด</em></a>
                </div>
                <?php
            } else {
                ?>
                <div class="col-sm-12 col-md-12">
                    <h2 class="text-center header-type">ประกาศ</h2>
                    <?php
                    // ========= Add news ====================================
                    $admin_txt = '  
                <p>
                ...
                <script>
                    ...
                    $sql = "SELECT * FROM tb_news WHERE type = 'notice' ORDER BY date DESC;";
                    $result = mysql_query($sql);
                        ...
                        while ($p = mysql_fetch_array($result)) {
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <p>' . $p['content_short'] . ' <a href="' . $p['type'] . '.php?news_id=' . $p['id'] . '">... อ่านต่อ</a></p>
                                </div>
                            </div>
                            <hr>
                            ';
