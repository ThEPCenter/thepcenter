 ...
 */ ?>
    ...
    <?php /* -------- One column popup -------- */ ?>
      ...
      <div class="container" id="popup" style="display: none; background-color: #f9f9f9; max-width: 750px; padding: 0;">
        <a title="วันแม่แห่งชาติ58" 
                   href="http://thep-center.org/upload02/mom58.jpg">
                    <img alt="consultant" style="max-width: 100%" src="http://thep-center.org/upload02/mom58.jpg">
                </a>
      </div>
