        ...
        <div class="row">
            <div class="col-md-12">
                ...
                if ($_GET['eq'] == 'XPS') {
                    ...
                    <h2 class="text-center">ระบบการจองชื่อเพื่อขอรับบริการด้วยเทคนิค XPS แบบ online <a target="_blank" href="http://thep-center.org/xps_reservation"><<ที่นี่>></a></h2><br>
                    <!-- #xpsNotice Modal -->
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <p class="text-center" style="color: green; font-size: 20px; font-weight: bold;">
                                        ระบบการจองชื่อเพื่อขอรับบริการด้วยเทคนิค XPS แบบ online <a target="_blank" href="http://thep-center.org/xps_reservation"><<ที่นี่>></a>
                                    </p> <br>
