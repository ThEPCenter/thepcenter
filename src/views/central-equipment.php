                ...
                if ($_GET['eq'] == 'XPS') {
                    ...
                    <table class="table-bordered">
                        ...
                        <tr>
                            ...
                            <td>ตารางอัตราค่าบริการ <a target="_blank" href="../files/eq/xps_rate.pdf">Download</a> ที่นี่</td>
                        </tr>
                        <tr>
                            <td class="text-center">ตัวอย่างการวิเคราะห์  :</td>
                            <td>ตัวอย่างการวิเคราะห์ด้วยเครื่อง XPS <a target="_blank" href="../files/eq/xps_example.pdf">Download</a> ที่นี่</td>
                        </tr>
                        <tr>
                            <td class="text-center">ติดต่อขอรับบริการ  :</td>
                            <td>
                                <p>ใบขอรับบริการ XPS <a target="_blank" href="../files/eq/ThEP-XPS-02.pdf">Download</a> ที่นี่<br>หรือสามารถกรอกใบขอรับบริการด้วยตนเองได้ที่</p>
                                <address>
                    ...
                    <p>&nbsp;</p>
                    <p class="text-center">เอกสารรายละเอียดเพิ่มเติม เครื่องวิเคราะห์ผิววัสดุ XPS คลิก <a target="_blank" href="../files/eq/xps_machine.pdf">Download</a> ที่นี่</p>
