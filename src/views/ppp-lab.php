        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <?php if ($lab == 'ion_beam') { ?>
                    ...
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2. ศึกษาการสั่นของชีวโมเลกุลที่ความถี่ต่ำโดยใช้เทคนิค TH<sub>z</sub> Spectroscopy เพื่อศึกษาโครงสร้างของโมเลกุลและการเคลื่อนที่เชิงสัมพัทธ์ของกลุ่มอะตอมซึ่งโยงใยกับการทำหน้าที่ในส่วนต่างๆของโมเลกุล</p>
                    <p>&nbsp;</p>
                    
                    <p style="text-align: center;">
                        <img style="max-width: 100%; height: auto;" src="http://www.thep-center.org/images/activity3/spectoscopy.jpg"><br>
                        <small>ไดอะแกรมแสดงระบบ TH<sub>z</sub> Spectroscopy ที่จะติดตั้งที่มหาวิทยาลัยเชียงใหม่</small>
                    </p>
                    <p>&nbsp;</p>

                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3. พัฒนาการถ่ายภาพด้วยรังสีเทร่าเฮิร์ตซ์ (TH<sub>z</sub> imaging) เพื่อนำมาใช้ในการตรวจสอบวัตถุแบบไม่รุกราน (noninvasive inspection) เนื่องจากรังสีเทร่าเฮิร์ตซ์สามารทะลุผ่านวัสดุห่อหุ้มหลากหลายชนิด เช่น กระดาษ พลาสติก หรือเสื้อผ้า และปลอดภัยต่อสิ่งมีชีวิต</p>
                    <p>&nbsp;</p>
