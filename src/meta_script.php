        ...
        <meta name="description" content="ThEP-Center">
        <meta name="author" content="ThEP-Center">
        <meta name="keywords" content="ThEP-Center, Physics, ศูนย์ความเป็นเลิศด้านฟิสิกส์, ฟิสิกส์">
        <meta name="description" content="ศูนย์ความเป็นเลิศด้านฟิสิกส์">
        ...
        <script src="../Metro-UI-CSS-master/javascript/accordion.js"></script>
        ...
        <script src="../Metro-UI-CSS-master/javascript/pagecontrol.js"></script>
        <script src="../Metro-UI-CSS-master/javascript/pagelist.js"></script>
        <script src="../Metro-UI-CSS-master/javascript/rating.js"></script>
        <script src="../Metro-UI-CSS-master/javascript/slider.js"></script>